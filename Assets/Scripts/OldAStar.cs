...
public class OldAStar : MonoBehaviour
{
    ...
    void AStarEarly()
    {
        ...
        temp[startX, startY].heuristic = 0 + Vector2.Distance(new Vector2(startX, startY), new Vector2(endX, endY));
        nodes[startX, startY].heuristic = 0 + Vector2.Distance(new Vector2(startX, startY), new Vector2(endX, endY));

        nodes[startX, startY].value = 0;
        temp[startX, startY].value = 0;
